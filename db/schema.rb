...
ActiveRecord::Schema.define(version: 20131204062102) do
  ...
  add_index "spree_supplier_bank_accounts", ["verification_token"], name: "index_spree_supplier_bank_accounts_on_verification_token"
  add_index "spree_supplier_bank_accounts", ["verified"], name: "index_spree_supplier_bank_accounts_on_verified"
